...
```tsx
import { captureScreenshot, type ScreenshotResult } from 'react-native-video-screenshot-plugin';
...
2. **Read the [API Reference](./README.md#-complete-api-reference)** for detailed method documentation
...
- Open an [issue](https://github.com/Pieczasz/react-native-video-screenshot-plugin/issues) for bugs or questions
- Contribute improvements via [pull requests](https://github.com/Pieczasz/react-native-video-screenshot-plugin/pulls)
